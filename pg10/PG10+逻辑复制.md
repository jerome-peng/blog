...
dst=# create subscription sub1_from_pub1 connection 'hostaddr=192.168.20.170 port=9432 user=postgres dbname=src' publication pub1 with(enabled,create slot,slot name='sub1_from_pub1'); 
ERROR:  syntax error at or near "slot"
LINE 1: ... dbname=src' publication pub1 with(enabled,create slot,slot ...
查看整个数据库集群有哪些订阅
